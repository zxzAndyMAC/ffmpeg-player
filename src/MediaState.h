...
namespace FFMPEG {
	class CPacketQueue;
	class MediaState : public IFFMpeg
	{
	public:
		MediaState();
		~MediaState();
		...
		virtual void do_exit() override;

		virtual unsigned int getWidth() override;
		virtual unsigned int getHeight() override;

		virtual void play(const char *filename) override;
		virtual void play(char* buffer, const unsigned int size) override;

		virtual int getDuration() override;
		virtual double get_master_clock() override;//获取主时钟

		virtual FFMPEG_EVENT event_loop() override;
